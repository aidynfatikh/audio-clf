#!/usr/bin/env bash
# Experiment 1: HuBERT × 3 compositions, augmentation ON (stage1 + stage2).
set -e
cd "$(dirname "$0")/.."
...
run exp1-hubert-b1        configs/splits/batch01_only_aug.yaml         stage1 stage2
run exp1-hubert-b1-b2     configs/splits/batch01_plus_batch02_aug.yaml stage1 stage2
run exp1-hubert-b1-b2-kz  configs/splits/all_three_aug.yaml            stage1 stage2
